function [sys,x0,str,ts] = SixJointSMCPlant(t,x,u,flag)
% 以下程序为凯恩方法的六关节动力学建模
switch flag
  case 0
...
% LuGre摩擦
F = 0.001*[u(7);u(8);u(9);u(10);u(11);u(12)];
% 外部扰动
d = 0.1*[2*sin(t);2*sin(t);2*sin(t);2*sin(t);2*sin(t);2*sin(t)];
% 库伦摩擦力
% F = 0.02*sign(dq);

%动力学方程
ddth = inv(M) * (tao - N * dq + d + F); %6*1矩阵
