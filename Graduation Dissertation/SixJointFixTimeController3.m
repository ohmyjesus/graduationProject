function [sys,x0,str,ts] = SixJointFixTimeController3(t,x,u,flag)
% 以下程序是 无神经网络补偿时的固定时间滑模控制  固定时间滑模采用的是NI Jun Kun的方法
switch flag
  case 0 %初始化
...
q5_alpha12 = 3; q5_belta12 = 17; q5_M21 = 11;q5_n21 = 3; q5_P21 = 3;q5_Q21 = 15;       % 其余为正奇数 且平均数也为正奇数 m1>n1 m2>n2 p1<q1 p2<q2 
q5_E2 = q5_P11/q5_Q11;
q5_E4 = q5_P21/q5_Q21;

q6_alpha11 = 3; q6_belta11 = 3; q6_M11 = 11;q6_n11 = 3; q6_P11 = 7;q6_Q11 = 11;      % alpha1,alpha2,belta1,belta2 为正数
q6_alpha12 = 3; q6_belta12 = 17; q6_M21 = 11;q6_n21 = 3; q6_P21 = 3;q6_Q21 = 15;       % 其余为正奇数 且平均数也为正奇数 m1>n1 m2>n2 p1<q1 p2<q2 
q6_E2 = q6_P11/q6_Q11;
q6_E4 = q6_P21/q6_Q21;

% q1~q4使用的控制器参数
alpha11 = 3; belta11 = 3; M11 = 11;n11 = 3; P11 = 7;Q11 = 11;      % alpha1,alpha2,belta1,belta2 为正数
alpha12 = 3; belta12 = 17; M21 = 11;n21 = 3; P21 = 3;Q21 = 15;       % 其余为正奇数 且平均数也为正奇数 m1>n1 m2>n2 p1<q1 p2<q2 
E2 = P11/Q11;
E4 = P21/Q21;
sizes = simsizes;
